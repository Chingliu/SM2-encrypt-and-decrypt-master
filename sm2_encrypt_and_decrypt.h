...
6. c2 is a octet string. Its length equals the length 
   of input message.
**************************************************/
KG_EXPORT_API int sm2_encrypt_data_test(const unsigned char *message,
...
5. c2 is a octet string. Its length equals the length 
   of input message.
**************************************************/
KG_EXPORT_API int gm_sm2_encrypt(const unsigned char *message,
                const int message_len,
		const unsigned char *pub_key,
		unsigned char *c1,
		unsigned char *c3,
...
**************************************************/
KG_EXPORT_API int gm_sm2_decrypt(const unsigned char *c1,
